...
set DEVOPS_TENANT_ID=6080182e-fa39-48db-8b51-669f994969c3
...
set DEVOPS_ORG=https://dev.azure.com/leslierockdupervil/

REM Azure DevOps project name (prefer no spaces)
set DEVOPS_PROJECT_NAME=MediSolution

REM Repository name or URL
set DEVOPS_REPO_NAME_OR_URL=MediSolution
